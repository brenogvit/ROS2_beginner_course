...
setup(
    ...
    zip_safe=True,
    maintainer='breno',
    maintainer_email='breno@todo.todo',
    ...
    entry_points={
        'console_scripts': [
            ...
            "turtle_controller_closer = my_py_pkg.turtle_controller_closer:main",
            "turtle_controller_choose = my_py_pkg.turtle_controller_choose:main",
        ],
    },
)
