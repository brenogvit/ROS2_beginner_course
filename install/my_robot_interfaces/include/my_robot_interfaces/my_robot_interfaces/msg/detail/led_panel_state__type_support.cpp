...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedPanelState_message_member_array[3] = {
  {
    "is_led1_on",  // name
    ...
    offsetof(my_robot_interfaces::msg::LedPanelState, is_led1_on),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LedPanelState, is_led2_on),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LedPanelState, is_led3_on),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
