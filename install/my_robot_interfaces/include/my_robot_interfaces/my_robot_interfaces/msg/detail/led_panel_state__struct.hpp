...
struct LedPanelState_
{
  ...
  explicit LedPanelState_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      this->is_led1_on = false;
      this->is_led2_on = false;
      this->is_led3_on = false;
    }
  }
  ...
  using _is_led1_on_type =
    bool;
  _is_led1_on_type is_led1_on;
  using _is_led2_on_type =
    bool;
  _is_led2_on_type is_led2_on;
  using _is_led3_on_type =
    bool;
  _is_led3_on_type is_led3_on;

  // setters for named parameter idiom
  Type & set__is_led1_on(
    const bool & _arg)
  {
    this->is_led1_on = _arg;
    return *this;
  }
  Type & set__is_led2_on(
    const bool & _arg)
  {
    this->is_led2_on = _arg;
    return *this;
  }
  Type & set__is_led3_on(
    const bool & _arg)
  {
    this->is_led3_on = _arg;
    return *this;
  }
  ...
  {
    if (this->is_led1_on != other.is_led1_on) {
      return false;
    }
    if (this->is_led2_on != other.is_led2_on) {
      return false;
    }
    if (this->is_led3_on != other.is_led3_on) {
      return false;
    }
    return true;
  }
