...
{
  // Field name: is_led1_on
  {
    cdr << (ros_message->is_led1_on ? true : false);
  }

  // Field name: is_led2_on
  {
    cdr << (ros_message->is_led2_on ? true : false);
  }

  // Field name: is_led3_on
  {
    cdr << (ros_message->is_led3_on ? true : false);
  }
  ...
  my_robot_interfaces__msg__LedPanelState * ros_message)
{
  // Field name: is_led1_on
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_led1_on = tmp ? true : false;
  }
  ...
  // Field name: is_led2_on
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_led2_on = tmp ? true : false;
  }
  ...
  // Field name: is_led3_on
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->is_led3_on = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: is_led1_on
  {
    size_t item_size = sizeof(ros_message->is_led1_on);
  ...
  // Field name: is_led2_on
  {
    size_t item_size = sizeof(ros_message->is_led2_on);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: is_led3_on
  {
    size_t item_size = sizeof(ros_message->is_led3_on);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
