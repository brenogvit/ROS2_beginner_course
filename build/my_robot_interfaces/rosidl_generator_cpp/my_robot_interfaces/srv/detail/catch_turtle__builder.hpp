...
{
  return ::my_robot_interfaces::srv::CatchTurtle_Request(rosidl_runtime_cpp::MessageInitialization::ZERO);
}
...
{
public:
  explicit Init_CatchTurtle_Response_success(::my_robot_interfaces::srv::CatchTurtle_Response & msg)
  : msg_(msg)
  {}
...
class Init_CatchTurtle_Response_name
{
public:
  Init_CatchTurtle_Response_name()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CatchTurtle_Response_success name(::my_robot_interfaces::srv::CatchTurtle_Response::_name_type arg)
  {
    msg_.name = std::move(arg);
    return Init_CatchTurtle_Response_success(msg_);
  }
...
{
  return my_robot_interfaces::srv::builder::Init_CatchTurtle_Response_name();
}
