  ...
  std::ostream & out)
{
  ...
  {
    out << "is_led1_on: ";
    rosidl_generator_traits::value_to_yaml(msg.is_led1_on, out);
    out << ", ";
  }
  ...
  {
    out << "is_led2_on: ";
    rosidl_generator_traits::value_to_yaml(msg.is_led2_on, out);
    out << ", ";
  }
  ...
  {
    out << "is_led3_on: ";
    rosidl_generator_traits::value_to_yaml(msg.is_led3_on, out);
  }
  out << "}";
